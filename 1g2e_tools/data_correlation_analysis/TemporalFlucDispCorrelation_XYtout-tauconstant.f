...
c        --Lecture de la configuration finale
         ...
         Close(1)
c        -- def incre
         Gxy1 = abs(Gxy11+Gxy10)*0.5
         tau1 = abs(Gxy11-Gxy10)
...
c        -- def incre
         Gxy2 = abs(Gxy21+Gxy20)*0.5
         Tau2 = abs(Gxy21-Gxy20)
         Close(1)
c        --Calcul des fluctuations de deplacements.
         Do k = 1,npa
            XX(1) = xIni(2,k)
...
c         Write(6,*) i,prod
         Write(77,'(i4,6(1x,e12.5))') i,Gxy,tau,(PROB_TAB(j,i),j=1,4)
         Write(6, '(i4,6(1x,e12.5))') i,Gxy,tau,(PROB_TAB(j,i),j=1,4)
      EndDo
